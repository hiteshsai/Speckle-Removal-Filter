function y = dpad2( I,ref, stepsize, nosteps, varargin )
%
% DPAD
%
...
%
%  DPAD: 
%      [Aja06] S. Ajaâ€?Fernandez, C. Alberola Lopez, On the Estimation of 
...
%  Noise Estimation: 
%
%     [Aja09]  S. Ajaâ€?Fernandez, G. Vegas Sanchezâ€?Ferrero, M. Martinâ€?Fernandez y C. 
%              Alberolaâ€?Lopez, Automatic Noise Estimation in Images Using Local Statistics. 
%              Additive and Multiplicative Cases. Image and Vision Computing, 
%              Vol. 27, Issue 6, May 2009, pp. 756â€?770. 
%
%     [Yu04]   Y. Yu and S. Acton, â€œEdge detection in ultrasound imagery using the
%              instantaneous coefficient of variation,â€? IEEE Trans. Image Proccess.,
%              vol. 13, no. 12, pp. 1640â€“1655, Dec. 2004.
%
...
%       dy = isodifstep(y, g);
%       y = y + stepsize(i) * 0.25 * dy;  % %updating for second order
      
      dy = isodifstep(y, g);
      y = y + stepsize(i) * 0.05* dy;  % updating
   end
